      ...
      tbody.insertAdjacentHTML(
        ...
        `
                <tr class="align-middle">
                    ...
                    <td>${goods[i][3]}</td>
                    <td><button class="btn good_delete btn-danger" data-delete="${
                      goods[i][0]
                    }">&#10006;</button></td>
                      <td><button class="btn good_delete btn-primary" data-goods="${
                        goods[i][0]
                      }">&#10149;</button></td>
                </tr>
                `
      ...
      if (goods[i][4] > 0) {
        ...
        document.querySelector(".cart").insertAdjacentHTML(
          ...
          `
                    ...
                    <td class='price-discount'><input data-goodid="${
                      goods[i][0]
                    }" type="text" value="${
            goods[i][5]
          }" min='0' max='100'> </td>
                    <td>${goods[i][6]}</td>
                    <td><button class="btn good-delete btn-danger" data-delete="${
                      goods[i][0]
                    }">&#10006;</button></td>
